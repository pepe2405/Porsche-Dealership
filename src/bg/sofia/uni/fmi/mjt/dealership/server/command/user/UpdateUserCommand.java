...
/**
 * The UpdateUserCommand class implements the Command interface and provides the functionality
 * for updating a user.
 * It uses an instance of UserManagerServiceImpl to update the user.
 * It uses an instance of LoggerImpl to log the operation.
 * It maintains the old password, new password and the user to be updated.
 * It provides a method to execute the command which updates the user and returns a DataContainer
...
public class UpdateUserCommand implements Command {
    ...
    public UpdateUserCommand(UserManagerServiceImpl userManagerServiceImpl,
                             String oldPassword, String newPassword, User user) {
    ...
    public DataContainer execute() {
        try {
            ...
            userManagerServiceImpl.updateUser(user.getUsername(), oldPassword, newPassword);
            return new DataContainer("User updated successfully", user);
